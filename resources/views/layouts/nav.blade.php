                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @endcan
                            @can('view-any', App\Models\Schoolowner::class)
                            <a class="dropdown-item" href="{{ route('schoolowners.index') }}">Schoolowners</a>
                            @endcan
                            @can('view-any', App\Models\User::class)
                            <a class="dropdown-item" href="{{ route('users.index') }}">Users</a>
                            @endcan
                            @can('view-any', App\Models\Systemowner::class)
                            <a class="dropdown-item" href="{{ route('systemowners.index') }}">Systemowners</a>
                            @endcan
                        </div>
